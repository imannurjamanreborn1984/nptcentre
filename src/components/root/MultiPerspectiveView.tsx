...
import type { SpiritualRoot, PerspectiveTab } from '../../types/root';
import { 
  ArrowLeft, 
  Dna, 
  BookMarked, 
...
interface MultiPerspectiveViewProps {
  root: SpiritualRoot;
  onBack: () => void;
  onOpenQuickAdd: (rootId: string, defaultCategory?: 'sains' | 'kitab' | 'popculture') => void;
  onStartPractice: (root: SpiritualRoot, type: 'dynamic_meditation' | 'khalwat') => void;
...
export const MultiPerspectiveView: React.FC<MultiPerspectiveViewProps> = ({
  ...
  const tabs: { id: PerspectiveTab; label: string; icon: React.ReactNode; count?: number }[] = [
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* TAB CONTENT: KITAB & TRADISI HIKMAH */}
      {activeTab === 'kitab' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="flex items-center justify-between">
            <p className="text-xs text-slate-500 dark:text-slate-400">
      ...
      {/* TAB CONTENT: POP CULTURE & CERITA RAKYAT */}
      ...
      {activeTab === 'latihan' && (
        <div className="space-y-6 animate-in fade-in duration-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Khalwat & Kontemplasi Sunyi Card */}
